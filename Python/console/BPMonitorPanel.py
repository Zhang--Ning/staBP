...
class MonitorPanel(wx.Panel):
  def __init__(self, parent):
    ...
    self.systolic_panel.SetPressure(120)
    self.diastolic_panel.SetPressure(80)
...
class PressureReadingPanel(wx.Panel):
  def __init__(self, parent, label):
    ...
    self.pressureText.SetForegroundColour(wx.Colour(83, 91, 239))
    self.pressureText.SetFont(wx.Font(50, wx.FONTFAMILY_DEFAULT, wx.NORMAL, wx.BOLD, faceName="Helvetica Neue"))
    ...
    self.labelText.SetForegroundColour(wx.Colour(83, 91, 239))
    self.unitsText.SetForegroundColour(wx.Colour(83, 91, 239))
    self.sizer = wx.BoxSizer(wx.HORIZONTAL)
    ...
    self.labelPanel.GetSizer().AddStretchSpacer(1)
    self.labelPanel.GetSizer().Add(self.labelText, 0, wx.EXPAND)
